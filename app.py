...
Multi-level Risk Classification via Probability Thresholds:
  Low Risk    : P(depression) < 0.233
  Medium Risk : 0.233 ≤ P(depression) < 0.750
  High Risk   : P(depression) ≥ 0.750
"""
